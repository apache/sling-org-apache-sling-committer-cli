...
public class SystemPropertiesRule extends ExternalResource {
    ...
    protected void before() {
        for (Map.Entry<String, String> prop : propsToOverride.entrySet()) propsToRestore.put(prop.getKey(), set(prop));
    }

    private String set(Map.Entry<String, String> prop) {
        if (prop.getValue() != null) return System.setProperty(prop.getKey(), prop.getValue());
    ...
    protected void after() {
        for (Map.Entry<String, String> prop : propsToRestore.entrySet()) set(prop);
    }
}
